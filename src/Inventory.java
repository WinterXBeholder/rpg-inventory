...
public class Inventory {
    ...
    static void addItem(Scanner console, String[] backpack){
        ...
        backpack[slot] = item;
         /* NOTE: the array is a reference type. Because of this, the reference is
         copied into the method, but not the values. Therefore, changing the array's
         values persists outside the method. Whereas primitives like int don't persist.*/
    }
